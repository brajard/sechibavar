...
#Steps time
defval STm   8000    |  1 an:17520  |  hiver: 0-4380   |   printemp: 4381 - 8760  |  ete: 8761-13140  | automne : 13140-17520
defval saison 4320   |  duration en PDT d une saison
#defval modo  1
...
#Espacios de varios
#space  nom       type  SZX     SZY    SZY      Traj
space  Snvm_init    M   kjindex  nvm           Tmodul     |  init_hydrolc
space  SkjindexW    M   kjindex                Tmodul     |  wind
space  Sngrnd_init  M   ngrnd                  Tcontr     |  int_thermosoil
space  Skjindexn    M   kjindex                Tcontr     |  int_thermosoil
...
modul  h_c_1          space Scontr       noward  output  1         |  target 
modul  h_c_2          space Scontr       noward  output  1         |  target 
modul  h_c_3          space Scontr       noward  output  1         |  target 
modul  h_c_4          space Scontr       noward  output  1         |  target 
modul  h_c_5          space Scontr       noward  output  1         |  target 
modul  h_c_6          space Scontr       noward  output  1         |  target 
modul  h_c_7          space Scontr       noward  output  1         |  target 
modul  h_c_8          space Scontr       noward  output  1         |  target 
modul  h_c_9          space Scontr       noward  output  1         |  target 
modul  h_c_10         space Scontr       noward  output  1         |  target 
modul  h_c_11         space Scontr       noward  output  1         |  target 
modul  h_c_12         space Scontr       noward  output  1         |  target 
modul  h_c_13         space Scontr       noward  output  1         |  target 

#parametres
modul  hum_c_1        space Scontr       noward  output  1         |  target 
modul  hum_c_2        space Scontr       noward  output  1         |  target 
modul  hum_c_3        space Scontr       noward  output  1         |  target 
modul  hum_c_4        space Scontr       noward  output  1         |  target 
modul  hum_c_5        space Scontr       noward  output  1         |  target 
modul  hum_c_6        space Scontr       noward  output  1         |  target 
modul  hum_c_7        space Scontr       noward  output  1         |  target 
modul  hum_c_8        space Scontr       noward  output  1         |  target 
modul  hum_c_9        space Scontr       noward  output  1         |  target 
modul  hum_c_10       space Scontr       noward  output  1         |  target 
modul  hum_c_11       space Scontr       noward  output  1         |  target 
modul  hum_c_12       space Scontr       noward  output  1         |  target 
modul  hum_c_13       space Scontr       noward  output  1         |  target 
...
modul  so_wet_c       space SParam       noward  output  1           target 
modul  so_dry_c       space SParam       noward  output  1	     target 
modul  min_drain_c    space SParam       noward  output  1           target 
modul  mx_drain_c     space SParam       noward  output  1	     target 
modul  e_drain_c      space SParam       noward  output  1	     target 
...
modul  H_soil_humrel   space SnvmH1i     input  14 output 1   tempo  | cout
...
#modul  init_hydrolc    space SnvmSi      input  7  output 3   tempo
modul  init_hydrolc2   space SnvmSn      input  5  output 3   
modul  int_lskin       space Skjindexn    input  2  output 1  
modul  int_thermosoil  space Sngrnd_init input  1  output 4  
modul  int_diaglev     space Sn2_init    input  4  output 2   
modul  int_humlev      space Sn1_init    input  4  output 3   
modul  int_dz2         space Sngrnd_22   input  array 21   output 3  
modul  int_slowproc    space Snbdl_init  input  4  output 3   
modul  int_diaghum     space Snbdl_hum   input array 11    output 1   
...
modul  I_swnet        space SkjindexIi  input  1  output 1   tempo 
...
#modul  SE_tempsol     space SkjindexSEi1 input  1  output 1   tempo 
...
modul  S_lai          space SnvmSi       input  13 output 1   tempo 


#DIFFUCO
modul  D_aero 	      space SkjindexDi  input  4  output 1   tempo 
...
modul  D_bare	      space SkjindexDi  input  5  output 1   tempo 
modul  D_inter	      space SnvmDi      input  8  output 2   tempo 
modul  D_trans        space SnvmDi      input  14 output 1   tempo 
...
modul  H_soil_verif   space SnvmHi      input  11 output 7   tempo 
...
modul  C_z0_rug       space SnvmCi       input 8  output 4      tempo  	| mismo espacio que S_veget
...
#ctin I_swnet            1  from C_albcalc3     1  i   1           | albedo vis	|
#ctin I_swnet            2  from C_albcalc3     1  i   2           | albedo nir	|--> swnet
...
ctin S_lai           13 from int_slowproc 2    i   nbdl       | lcanop		|
...
ctin C_z0_rug           1  from S_veget      1    i   1    t-1    | veget1		|
ctin C_z0_rug           2  from S_veget      1    i   j    t-1    | veget		|
...
ctin init_hydrolc2   2  from init_hydrolc2  1  i  j-1       	| vegtot1	|
ctin init_hydrolc2   3  from init_hydrolc2  3  i  j-1       	| mx_eau_var1	|--> 1) vegtot
ctin init_hydrolc2   4  from mx_eau_eau     1  i            	| mx_eau_eau	|
ctin init_hydrolc2   5  from dpu_cste1      1  i            	| dpu_cste	|

ctin int_lskin      1  from so_cond         1  1          	| so_cond	|
ctin int_lskin      2  from so_capa         1  1          	| so_capa	|--> 1)lskin

ctin int_thermosoil 1  from int_lskin            1  1          	| lskin   	|--> 1) dz1     2) dz2

ctin int_slowproc   1  from dpu_cste1       1  i	     	| dpu_cste1	|
ctin int_slowproc   2  from int_slowproc    2  i  j-1	     	| temp1		|--> 1) diaglev
ctin int_slowproc   3  from int_slowproc    3  i  j-1	     	| min_val1	|--> 2) lcanop
ctin int_slowproc   4  from int_slowproc    1  i  j-1	     	| diaglev1	|

ctin int_diaghum 1..11 from int_slowproc   1   1  1..11         | diaglev	|--> 1) diaglev

ctin int_dz2     1..7   from int_thermosoil  1  1..7            | dz1		|--> 1) dz1
ctin int_dz2     8..14  from int_thermosoil  2  1..7            | dz2		|--> 2) dz2
ctin int_dz2     15..21 from int_thermosoil  3  1..7            | zz_coef	|--> 3) zz_coef

ctin int_diaglev    1  from int_thermosoil  2  i       		| dz2		|
ctin int_diaglev    2  from int_diaglev     2  i-1  j      	| lev_prog1	|--> 1) intfactw_s
ctin int_diaglev    3  from int_slowproc    1  1    j      	| diaglev	|--> 2) lev_prog1
ctin int_diaglev    4  from int_slowproc    1  1    j-1      	| diaglev	|

ctin int_humlev     1  from int_dz2         2  1    j     	| dz2		|--> 1) intfactw_s
ctin int_humlev     2  from int_humlev      2  i-1    j      	| lev_prog1	|--> 2) lev_prog1
ctin int_humlev     3  from int_humlev      3  i  j-1      	| lev_diag1	|--> 2) lev_prog1
ctin int_humlev     4  from int_diaghum     1  i  1      	| diaglev	|--> 2) lev_prog1
...
ctin D_aero          3  from C_z0_rug	    1  i  nvm  t      | z0		|
ctin D_aero          4  from C_z0_rug	    2  i  nvm  t      | rugosite	|
...
ctin D_bare          4  from SE_evaplim     1  i             | evap_bare_lim	|
ctin D_bare          5  from S_veget        1  i  1   t-1    | veget		|
...
ctin E_beg_netrad    1  from C_zol_calc     1  i             | emis		|
...
ctin E_surftemp3     1  from C_zol_calc     1  i             | emis		|
...
ctin E_flux_tslw     1  from C_zol_calc     1  i             | emis		|				i
...
ctin E_netrad        1  from E_beg_netrad    1  i      t     | netrad		|
...
ctin E_flux_corr     3  from C_zol_calc      1  i            | emis		|
...
ctin H_snow_melt     2  from H_snow         1  i      t     | snow		|0
...
ctin H_veg_water2    13 from init_hydrolc2  2  i nvm        | ruu_ch		|
...
ctin H_soil_flxcorr  5  from init_hydrolc2  1  i nvm        | vegtot		|
...
ctin H_soil_trans    9  from init_hydrolc2  1  i nvm        | vegtot		|
...
ctin H_soil_runoff   7  from init_hydrolc2  2  i nvm        | ruu_ch		|
ctin H_soil_runoff   8  from init_hydrolc2  3  i nvm        | mx_eau_var	|
ctin H_soil_runoff   9  from dpu_cste1      1  i            | dpu_cste		|

ctin H_soil_dlock 1..5  from H_soil_runoff 1..5 i  j   t     | gqsb dsg bqsb dsp dss	|
ctin H_soil_dlock    6  from init_hydrolc2   2  i nvm        | ruu_ch			|
ctin H_soil_dlock    7  from min_drain       1  i   	     | min_drain		|---> gqsb dsg bqsb dsp dss	i
...
ctin H_soil_diff     6  from init_hydrolc2   1  i nvm        | vegtot		|
...
ctin H_soil_dsp	     4  from init_hydrolc2   2  i nvm        | ruu_ch		|
...
ctin H_soil_verif 2..3  from H_soil_dlock 1..2  i  j    t    | gqsb dsg   	|--> runoff  gqsb dsg bqsb dsp dss bad
...
ctin H_soil_verif 8..9  from init_hydrolc2 2..3 i nvm        | ruu_ch mx_eau_var|
...
ctin H_soil_mean     6  from init_hydrolc2   1  i nvm        | vegtot		|
...
ctin H_soil_dsp2     4  from init_hydrolc2   2  i nvm        | ruu_ch		|
...
ctin H_soil_runofft  6  from init_hydrolc2   1  i nvm        | vegtot		|
...
ctin H_soil_dsg      2  from init_hydrolc2   2  i  nvm       | ruu_ch		|--> mean_dsg
ctin H_soil_dsg      3  from init_hydrolc2   1  i  nvm       | vegtot		|
ctin H_soil_dsg      4  from H_soil_dsg1     1  i  nvm  t    | init mean_dsg	|

ctin H_soil_stress 1..2 from H_soil_verif 2..3  i  j    t    | gqsb dsg		|    	
ctin H_soil_stress   3  from H_soil_dsp2     2  i  j    t    | bqsb 		|--> 1) 
ctin H_soil_stress   4  from H_soil_dsp2     1  i  j    t    | dsp		|--> 1) humrel   2)vegstress
ctin H_soil_stress   5  from H_soil_verif    6  i  j    t    | dss		|--> 3) a_subgrd
ctin H_soil_stress   6  from init_hydrolc2   2  i  nvm       | ruu_ch		|--> 4) dsg
ctin H_soil_stress   7  from hum_c_1	     1  i            | hum_c_1	        |     
ctin H_soil_stress   8  from hum_c_2	     1  i            | hum_c_2   	|     
ctin H_soil_stress   9  from hum_c_3	     1  i            | hum_c_3	        |     
ctin H_soil_stress   10 from hum_c_4	     1  i            | hum_c_4	        |     
ctin H_soil_stress   11 from hum_c_5	     1  i            | hum_c_5 	        |     
ctin H_soil_stress   12 from hum_c_6	     1  i            | hum_c_6	        |--> humrel     
ctin H_soil_stress   13 from hum_c_7	     1  i            | hum_c_7	        |     
ctin H_soil_stress   14 from hum_c_8	     1  i            | hum_c_8 	        |     
ctin H_soil_stress   15 from hum_c_9	     1  i            | hum_c_9 	        |     
ctin H_soil_stress   16 from hum_c_10	     1  i            | hum_c_10	        |     
ctin H_soil_stress   17 from hum_c_11	     1  i            | hum_c_11	        |     
ctin H_soil_stress   18 from hum_c_12	     1  i            | hum_c_12	        |   
ctin H_soil_stress   19 from hum_c_13	     1  i            | hum_c_13	        |       
ctin H_soil_stress   20 from dpu_cste1       1  i            | dpu_cste		|

ctin H_soil_humrel   1  from H_soil_stress   1  i  j    t    | humrel		| 
ctin H_soil_humrel   2  from h_c_1	     1  i            | humrel_c_1       |     
ctin H_soil_humrel   3  from h_c_2	     1  i            | humrel_c_2       |     
ctin H_soil_humrel   4  from h_c_3	     1  i            | humrel_c_3       |     
ctin H_soil_humrel   5  from h_c_4	     1  i            | humrel_c_4       |     
ctin H_soil_humrel   6  from h_c_5	     1  i            | humrel_c_5       |     
ctin H_soil_humrel   7  from h_c_6	     1  i            | humrel_c_6       |--> humrel     
ctin H_soil_humrel   8  from h_c_7	     1  i            | humrel_c_7       |     
ctin H_soil_humrel   9  from h_c_8	     1  i            | humrel_c_8       |     
ctin H_soil_humrel   10 from h_c_9	     1  i            | humrel_c_9       |     
ctin H_soil_humrel   11 from h_c_10	     1  i            | humrel_c_10      |     
ctin H_soil_humrel   12 from h_c_11	     1  i            | humrel_c_11      |     
ctin H_soil_humrel   13 from h_c_12	     1  i            | humrel_c_12      |   
ctin H_soil_humrel   14 from h_c_13	     1  i            | humrel_c_13      |       
...
ctin H_soil_shum     4  from init_hydrolc2   3  i nvm        | mx_eau_var	|
ctin H_soil_shum     5  from int_slowproc    1  i j          | diaglev   	|
ctin H_soil_shum     6  from int_slowproc    1  i j-1        | diaglev1		|
...
ctin H_soil_rsol     2  from S_veget         1  i  1    t-1  | veget		|--> 2) litterhumdiag
...
ctin T_profile       8  from int_thermosoil 4 1	    	     | lambda
...
ctin T_coef_soil     5  from int_dz2	  1    i   j 	     | dz1		|--> 1) zdz1 2) zdz2
ctin T_coef_soil     6  from int_dz2	  2    i   j	     | dz2		|--> 3) pcapa_en
ctin T_coef_soil     7  from int_dz2	  3    i   j	     | zz_coef		|
ctin T_coef_soil     8  from int_dz2	  3    i   j-1	     | zz_coef1		|
...
ctin T_coef_diff     7  from int_thermosoil 4 1	    	     | lambda		|

ctin T_hum_wet    1..nbdl        from H_soil_shum   1   i       1..nbdl  t | shumdiag |-->wetdiag
ctin T_hum_wet   nbdl1..nbdl2   from int_humlev    1   1..nbdl j    	   | int_w    |

ctin T_diag_stemp 1..ngrnd  	from T_profile     1   i  1..ngrnd t | ptn		|-->stempdiag
ctin T_diag_stemp 8..14  	from int_diaglev   1   1..ngrnd j   | 			|


#ctin SE_tempsol      1  from E_surftemp_pt 2   i        t       | temp_sol_new
...
order modinspace SParam 
	order YA1  rsol_cste   so_capa_wet   so_capa_dry    min_drain    max_drain  exp_drain  so_capa  so_cond   dpu_cste1   mx_eau_eau rveg_par forder
forder

...
#include "ncutil.h"//netcdf		//Read nc files
#include "constantes_veg.h"		//Vegetal constants
#include "constantes_soil.h"		//soil constants
#include "run_sechiba.h"		//Initial conditions of the experience
#include "constantes_norm.h"		//Normalization constants
#include "derivfunc.h"			//derivative of sechiba.h functions
#include "xfunctions.h"		//personal functions
